    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($shopSlug) {
            ...
            View::share('company', [
                ...
                'logo' => $shop->logo_path ?: 'https://ui-avatars.com/api/?name='.urlencode($shop->name).'&background=1A1A1A&color=fff',
                'cover' => $shop->cover_path ?: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=1200',
