...
<body class="bg-[#070913] text-gray-100 min-h-screen selection:bg-brand-500 selection:text-white relative"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
            ...
            <div class="lg:col-span-6 text-center lg:text-left space-y-8">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 pt-6">
                    <a href="#precios"
                        class="w-full sm:w-auto text-center bg-cyan-500 hover:bg-cyan-400 hover:scale-[1.02] text-white font-black px-10 py-4 rounded-2xl shadow-[0_0_25px_rgba(34,211,238,0.35)] transition-all duration-300 text-sm md:text-base">
                ...
                <div class="mt-4 flex justify-center lg:justify-start">
                    <span
                        class="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 text-cyan-200 text-[11px] font-black uppercase tracking-[0.18em] px-4 py-2 rounded-full shadow-sm">
    ...
    @php
        $shopsWithCategories = $shops->map(function ($shop) {
            ...
            if (
                str_contains($desc, 'detallito') ||
                str_contains($desc, 'regalo') ||
                str_contains($desc, 'detalle') ||
                str_contains($desc, 'sorpresa') ||
                str_contains($desc, 'taza') ||
                str_contains($desc, 'globo') ||
                str_contains($desc, 'flores')
            ) {
                $category = 'Detalles y Regalos';
            } elseif (
                str_contains($desc, 'moda') ||
                str_contains($desc, 'ropa') ||
                str_contains($desc, 'estilo') ||
                str_contains($desc, 'calzado') ||
                str_contains($desc, 'boutique') ||
                str_contains($desc, 'wear') ||
                str_contains($desc, 'shoes')
            ) {
                $category = 'Moda y Estilo';
            } elseif (
                str_contains($desc, 'comida') ||
                str_contains($desc, 'restaurante') ||
                str_contains($desc, 'gastronomia') ||
                str_contains($desc, 'burger') ||
                str_contains($desc, 'dulce') ||
                str_contains($desc, 'bocado') ||
                str_contains($desc, 'pizza') ||
                str_contains($desc, 'cafe') ||
                str_contains($desc, 'sushi')
            ) {
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch justify-center">
                ...
                <div id="plan-standard"
                    ...
                    <div>
                        <div class="flex justify-between items-start">
                            ...
                            <span
                                class="bg-gradient-to-r from-sky-500 to-cyan-400 text-slate-950 text-[8px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full shadow-[0_0_14px_rgba(14,165,233,0.5)] animate-pulse shrink-0">⚡
                                7 Días</span>
                        </div>
                        <div
                            class="mt-3 inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-cyan-200 shadow-[0_0_15px_rgba(34,211,238,0.12)]">
                            <span class="text-[11px]">🏦</span>
                            <span>Tasa BCV</span>
                        </div>
                        <p class="text-[11px] text-slate-400 mt-3 leading-relaxed">Ideal para pequeños negocios y
                            emprendedores que desean digitalizarse.</p>

                        <!-- Banner prueba gratis -->
                        <div
                            class="mt-3 rounded-2xl bg-gradient-to-r from-sky-500/15 via-cyan-500/10 to-sky-500/15 border border-sky-500/30 p-3 shadow-[0_0_18px_rgba(14,165,233,0.12)] flex items-center gap-2.5">
                            <div
                                class="w-7 h-7 rounded-xl bg-sky-500/20 border border-sky-500/30 flex items-center justify-center shrink-0">
                                <span class="text-sm">🎁</span>
                            </div>
                            <div>
                                <p class="text-[10px] font-black text-sky-300 uppercase tracking-wider leading-tight">
                                    ¡Incluye 7 Días de Prueba Gratis!</p>
                                <p class="text-[9px] text-slate-500 mt-0.5">Sin tarjeta. Sin compromisos. Cancela
                                    cuando quieras.</p>
                            </div>
                        </div>
                        ...
                        <div class="my-6">
                            ...
                            <div x-show="billingPeriod === 'monthly'" x-transition class="space-y-1">
                                ...
                                <span
                                    class="bg-cyan-500/10 text-cyan-400 border border-cyan-500/25 text-[8px] font-extrabold uppercase px-2.5 py-0.5 rounded-full inline-block mt-1 hover:scale-105 transition-all duration-200 cursor-pointer"
                            ...
                            <div x-show="billingPeriod === 'yearly'" x-transition class="space-y-1">
                                ...
                                <span x-show="exchangeRate"
                                    class="text-[11px] text-emerald-400 font-bold block mt-0.5" x-transition>
                                    <span x-text="(11.99 * exchangeRate).toFixed(2)"></span> Bs. <span
                                        class="text-[9px] text-slate-500">/ mes</span>
                                </span>
                                <span class="text-[9px] text-slate-400 block font-semibold">
                                    Facturado anualmente ($143.90/año<span x-show="exchangeRate"
                                        class="text-emerald-400/90"> / <span
                                            x-text="(143.90 * exchangeRate).toFixed(2)"></span> Bs.</span>)
                                </span>
                                <span
                                    class="bg-cyan-500/10 text-cyan-400 border border-cyan-500/25 text-[8px] font-extrabold uppercase px-2 py-0.5 rounded-full inline-block">Ahorra
                                    20%</span>
                            </div>
                        </div>
                ...
                <div id="plan-premium"
                    ...
                    <span
                        class="absolute -top-4 right-6 bg-purple-600 text-white text-[9px] uppercase font-black tracking-widest px-4.5 py-1.5 rounded-full shadow-[0_0_15px_rgba(168,85,247,0.6)] select-none z-10">
                        ✨ RECOMENDADO
                    </span>
                    ...
                    <div
                        ...
                        <div class="relative z-10">
                            ...
                            <div
                                class="mt-3 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-violet-200 shadow-[0_0_15px_rgba(168,85,247,0.12)]">
                                <span class="text-[11px]">🏦</span>
                                <span>Tasa BCV</span>
                            </div>
                            <p class="text-[11px] text-slate-300 mt-3 leading-relaxed">Nuestra solución corporativa con
                                insignia VIP y marca blanca completa.</p>
                            ...
                            <div class="my-6">
                                ...
                                <div x-show="billingPeriod === 'monthly'" x-transition class="space-y-1">
                                    ...
                                    <span
                                        class="bg-purple-500/20 text-purple-400 border border-purple-500/25 text-[8px] font-extrabold uppercase px-2.5 py-0.5 rounded-full inline-block mt-1 hover:scale-105 transition-all duration-200 cursor-pointer"
                                        @click="billingPeriod = 'yearly'">
                                ...
                                <div x-show="billingPeriod === 'yearly'" x-transition class="space-y-1">
                                    <div class="text-3xl font-black text-white flex items-baseline gap-1">
                                        $17.49 <span class="text-[10px] font-bold text-cyan-400">/ mes
                                            equivalent</span>
                                    </div>
                                    <span x-show="exchangeRate"
                                        class="text-[11px] text-emerald-400 font-bold block mt-0.5" x-transition>
                                        <span x-text="(17.49 * exchangeRate).toFixed(2)"></span> Bs. <span
                                            class="text-[9px] text-slate-500">/ mes</span>
                                    </span>
                                    <span class="text-[9px] text-slate-400 block font-semibold">
                                        Facturado anualmente ($209.92/año<span x-show="exchangeRate"
                                            class="text-emerald-400/90"> / <span
                                                x-text="(209.92 * exchangeRate).toFixed(2)"></span> Bs.</span>)
                                    </span>
                                    <span
                                        class="bg-purple-500/20 text-purple-400 border border-purple-500/25 text-[8px] font-extrabold uppercase px-2 py-0.5 rounded-full inline-block">Ahorra
                                        30%</span>
                                </div>
                            </div>
                ...
                <div id="plan-custom"
                    ...
                    <div>
                        ...
                        <div
                            class="mt-3 inline-flex items-center gap-2 rounded-full border border-pink-500/20 bg-pink-500/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-pink-200 shadow-[0_0_15px_rgba(236,72,153,0.12)]">
                            <span class="text-[11px]">🏦</span>
                            <span>Tasa BCV</span>
                        </div>
            ...
            <div class="mt-16 text-center max-w-4xl mx-auto">
                <p class="text-[10px] md:text-xs text-slate-500 leading-relaxed font-semibold px-4">
                    ⚠️ Los planes Standard y Premium incluyen 7 días de prueba gratuita. Estos planes cubren soporte
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-xs text-purple-300 font-semibold"
                                    x-text="billingPeriod === 'yearly' ? 'Frecuencia de pago anual (Ahorra 30%)' : 'Frecuencia de pago mensual'">
                                </p>
                                <p class="text-lg font-black text-white"
                                    x-text="billingPeriod === 'yearly' ? '$209.92 USD / año ($17.49/mes)' : '$24.99 USD / mes'">
                                </p>
                            </div>
                            <a href="/register"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2.5 text-xs">
                        ...
                        <li><a href="#vs-competencia"
                                class="text-slate-400 hover:text-cyan-400 transition-colors font-semibold">Comparativa
                                con la Competencia</a></li>
                    </ul>
                </div>
