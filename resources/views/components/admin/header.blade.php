...
<header class="admin-topbar accent-surface px-3 md:px-8 py-2.5 md:py-3 z-40 w-full">
    <div class="admin-topbar-inner">
        ...
        <div class="admin-topbar-actions">
            ...
            <!-- Acciones escritorio -->
            <button type="button" @click="darkMode = !darkMode" class="accent-icon-btn relative p-2 rounded-full transition-colors cursor-pointer hidden md:block" title="Alternar tema">
                ...
                >
                    <div class="accent-surface rounded-2xl shadow-xl border border-white/15 overflow-hidden">
                        <div class="flex items-center justify-around gap-1 px-3 py-3 border-b border-white/15">
                            <button type="button" @click="darkMode = !darkMode" class="accent-icon-btn p-2.5 rounded-full" title="Alternar tema">
