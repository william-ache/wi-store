...
<nav class="admin-bottombar accent-surface admin-mobile-nav md:hidden z-40">
    <div class="flex justify-around items-center w-full px-2">
        ...
        @endif
        @if(\App\Support\PlanFeatures::hasBusinessPanel($currentShop ?? config('current_shop')) && in_array('orders', $currentShop->enabled_modules ?? ['categories', 'products', 'orders', 'clients', 'invoices', 'delivery', 'analytics', 'announcements', 'referrals']))
