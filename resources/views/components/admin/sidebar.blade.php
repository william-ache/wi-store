    ...
    <div>
        ...
        <nav class="p-3.5 space-y-1.5 custom-scrollbar overflow-y-auto max-h-[calc(100vh-140px)]">
            ...
            <a href="/{{ config('current_shop')->slug }}/admin/analytics" 
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg transition text-sm font-semibold {{ request()->is('*/admin/analytics*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            ...
            <div x-data="{ open: {{ request()->is('*/admin/products*') || request()->is('*/admin/categories*') ? 'true' : 'false' }} }" class="space-y-1">
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition text-sm font-semibold {{ request()->is('*/admin/products*') || request()->is('*/admin/categories*') ? 'bg-slate-800/40 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group">
                ...
                <div x-show="open" 
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/products" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/products*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/categories" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/categories*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            ...
            <div x-data="{ open: {{ request()->is('*/admin/orders*') || request()->is('*/admin/bookings*') || request()->is('*/admin/abandoned-carts*') ? 'true' : 'false' }} }" class="space-y-1">
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition text-sm font-semibold {{ request()->is('*/admin/orders*') || request()->is('*/admin/bookings*') || request()->is('*/admin/abandoned-carts*') ? 'bg-slate-800/40 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group">
                    <div class="flex items-center gap-2.5">
                ...
                <div x-show="open" 
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/orders" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/orders*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/bookings" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/bookings*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/abandoned-carts" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/abandoned-carts*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            ...
            <div x-data="{ open: {{ request()->is('*/admin/clients*') ? 'true' : 'false' }} }" class="space-y-1">
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition text-sm font-semibold {{ request()->is('*/admin/clients*') ? 'bg-slate-800/40 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group">
                    <div class="flex items-center gap-2.5">
                ...
                <div x-show="open" 
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/clients" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/clients*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            ...
            <div x-data="{ open: false }" class="space-y-1">
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition text-sm font-semibold text-slate-400 hover:bg-slate-800 hover:text-white group">
                    <div class="flex items-center gap-2.5">
            ...
            <div x-data="{ open: {{ request()->is('*/admin/announcements*') || request()->is('*/admin/coupons*') ? 'true' : 'false' }} }" class="space-y-1">
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition text-sm font-semibold {{ request()->is('*/admin/announcements*') || request()->is('*/admin/coupons*') ? 'bg-slate-800/40 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group">
                    <div class="flex items-center gap-2.5">
                ...
                <div x-show="open" 
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/announcements" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/announcements*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/coupons" 
                       class="flex items-center gap-2.5 px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/coupons*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            ...
            <div x-data="{ open: {{ request()->is('*/admin/subscription*') || request()->is('*/admin/feedback*') || request()->is('*/admin/settings*') ? 'true' : 'false' }} }" class="space-y-1">
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition text-sm font-semibold {{ request()->is('*/admin/subscription*') || request()->is('*/admin/feedback*') || request()->is('*/admin/settings*') ? 'bg-slate-800/40 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group">
                    <div class="flex items-center gap-2.5">
                ...
                <div x-show="open" 
                    ...
                    <a href="/{{ config('current_shop')->slug }}/admin/subscription" 
                       class="flex items-center justify-between px-3 py-2 rounded-md transition text-xs font-semibold {{ request()->is('*/admin/subscription') ? 'bg-purple-650 text-white font-bold shadow-[0_0_12px_rgba(168,85,247,0.25)]' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
