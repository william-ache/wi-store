    ...
    <div>
        ...
        <nav class="p-3.5 space-y-1 custom-scrollbar overflow-y-auto max-h-[calc(100vh-140px)]">
            ...
            <a href="/{{ config('current_shop')->slug }}/admin/bookings" 
               class="flex items-center gap-2.5 px-3 py-2 rounded-lg transition text-xs font-semibold {{ request()->is('*/admin/bookings*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                <span>Reservas</span>
            </a>
            <a href="/{{ config('current_shop')->slug }}/admin/abandoned-carts" 
               class="flex items-center gap-2.5 px-3 py-2 rounded-lg transition text-xs font-semibold {{ request()->is('*/admin/abandoned-carts*') ? 'bg-slate-800 text-white font-bold' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
