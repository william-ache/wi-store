...
<head>
    ...
    <style>
        ...
        body { font-family: 'Outfit', sans-serif; background-color: #070913; }
        .gpu-accelerated { transform: translate3d(0,0,0); backface-visibility: hidden; will-change: transform; }
        .blur-accelerated { transform: translate3d(0,0,0); backface-visibility: hidden; will-change: filter; }

        @keyframes wave-1 {
            0%,100% { d: path("M-100,100 C200,300 400,-100 800,200 C1200,500 1300,900 1500,800"); }
            33%      { d: path("M-100,130 C170,260 430,-60 820,170 C1180,530 1330,860 1500,830"); }
            66%      { d: path("M-100,70 C230,340 370,-140 780,230 C1220,470 1270,940 1500,770"); }
        }
        @keyframes wave-2 {
            0%,100% { d: path("M-50,200 C250,400 500,50 900,400 C1300,750 1200,1050 1600,950"); }
            33%      { d: path("M-50,170 C280,360 470,90 920,360 C1270,780 1230,1010 1600,920"); }
            66%      { d: path("M-50,230 C220,440 530,10 880,440 C1330,720 1170,1090 1600,980"); }
        }
        @keyframes wave-3 {
            0%,100% { d: path("M1500,-50 C1100,150 1000,500 600,600 C200,700 0,1100 -200,1000"); }
            50%      { d: path("M1500,-20 C1070,180 970,470 630,570 C170,730 30,1070 -200,1030"); }
        }
        @keyframes wave-4 {
            0%,100% { d: path("M1550,50 C1150,250 900,400 500,700 C100,1000 -100,900 -250,1100"); }
            33%      { d: path("M1550,80 C1120,280 870,370 530,670 C70,1030 -70,870 -250,1130"); }
            66%      { d: path("M1550,20 C1180,220 930,430 470,730 C130,970 -130,930 -250,1070"); }
        }
        @keyframes wave-5 {
            0%,100% { d: path("M-100,800 C300,600 500,900 900,800 C1300,700 1400,200 1600,300"); }
            50%      { d: path("M-100,770 C330,570 470,930 870,830 C1330,670 1370,230 1600,270"); }
        }
        ...
        .animate-wave-4 { animation: wave-4 14s ease-in-out infinite; }
        .animate-wave-5 { animation: wave-5 16s ease-in-out infinite; }

        input[type="color"] { -webkit-appearance: none; width: 100%; height: 100%; border: none; cursor: pointer; background: transparent; padding: 0; }
        ...
        .field-valid   { border-color: rgba(34,197,94,0.5)  !important; }
        .field-invalid { border-color: rgba(239,68,68,0.5)  !important; }
        .field-checking { border-color: rgba(14,165,233,0.5) !important; }
    </style>
</head>
<body class="min-h-screen text-slate-100 flex flex-col justify-between relative overflow-x-hidden selection:bg-sky-500 selection:text-white"
      x-data="{
          /* ── Campos ──────────────────────────────── */
          shopName: '',
          email: '',
          ...
          /* ── Estado nombre ───────────────────────── */
          nameStatus: 'idle',   /* idle | checking | available | taken | short */
          _nameTimer: null,
          checkName() {
    ...
    <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-[#070913] gpu-accelerated">
        <div class="absolute -top-[10%] -right-[5%] w-[600px] h-[600px] rounded-full bg-gradient-to-r from-sky-600/20 to-indigo-600/20 blur-[120px] blur-accelerated"></div>
        ...
        <svg class="absolute inset-0 w-full h-full opacity-40" preserveAspectRatio="none" viewBox="0 0 1440 1024" fill="none">
            <defs>
            ...
            <path class="animate-wave-1" d="M-100,100 C200,300 400,-100 800,200 C1200,500 1300,900 1500,800" stroke="url(#ng1)" stroke-width="1.5" fill="none"/>
            <path class="animate-wave-2" d="M-50,200 C250,400 500,50 900,400 C1300,750 1200,1050 1600,950"  stroke="url(#ng1)" stroke-width="1"   fill="none" opacity="0.6"/>
            <path class="animate-wave-3" d="M1500,-50 C1100,150 1000,500 600,600 C200,700 0,1100 -200,1000" stroke="url(#ng2)" stroke-width="1.5" fill="none"/>
            <path class="animate-wave-4" d="M1550,50 C1150,250 900,400 500,700 C100,1000 -100,900 -250,1100" stroke="url(#ng2)" stroke-width="1"  fill="none" opacity="0.6"/>
            <path class="animate-wave-5" d="M-100,800 C300,600 500,900 900,800 C1300,700 1400,200 1600,300"  stroke="url(#ng1)" stroke-width="1"   fill="none" opacity="0.4"/>
        </svg>
    </div>
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-8 relative z-10">
        <div class="w-full max-w-lg">
            ...
            <div class="flex justify-center mb-5">
                <div class="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 rounded-full px-5 py-2 shadow-[0_0_25px_rgba(56,189,248,0.18)]">
                    <span class="w-2 h-2 rounded-full bg-sky-400 animate-pulse"></span>
                    <span class="text-sky-300 text-[11px] font-black uppercase tracking-widest">🎁 7 Días de Prueba Gratuita — Sin Tarjeta</span>
                </div>
            </div>

            <!-- Card -->
            <div class="w-full bg-[#0d1127]/60 backdrop-blur-md border border-white/10 rounded-[2rem] p-8 md:p-10 shadow-2xl relative group overflow-hidden">
                <div class="absolute -top-20 -right-20 w-48 h-48 bg-sky-500/15 rounded-full blur-2xl pointer-events-none group-hover:bg-cyan-500/15 transition-all duration-700"></div>
                <div class="absolute -bottom-20 -left-20 w-40 h-40 bg-purple-500/10 rounded-full blur-2xl pointer-events-none"></div>

                <div class="text-center mb-8 relative z-10">
                    <span class="inline-block bg-sky-500/15 text-sky-400 text-[10px] uppercase font-black tracking-widest px-4 py-1.5 rounded-full border border-sky-500/30 shadow-[0_0_15px_rgba(56,189,248,0.2)] mb-4">
                        Plan Standard
                    </span>
                    ...
                    <p class="text-xs text-slate-400 mt-2 max-w-xs mx-auto leading-relaxed">
                        Configura tu marca y comienza a vender en segundos. <span class="text-sky-400 font-bold">Gratis por 7 días.</span>
                    </p>
                </div>
                ...
                <form @submit.prevent="submitForm()" class="space-y-5 relative z-10">
                    ...
                    <div class="space-y-1.5">
                        <label for="shop_name" class="text-[11px] font-black uppercase tracking-wider text-slate-400 block pl-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="shop_name" name="shop_name" required
                                   x-model="shopName" @input="checkName()"
                                   placeholder="Ej: Tienda Click, Sabores Y&B..."
                                   :class="nameBorderClass"
                                   class="w-full bg-slate-900/80 border border-slate-800/80 rounded-2xl px-4 py-3.5 pl-11 pr-11 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-sky-500/40 transition-all shadow-inner">
                            <!-- Indicador derecho -->
                        ...
                        <div class="pl-1 text-[10px] font-bold flex items-center gap-1.5 transition-all" x-cloak>
                            <template x-if="nameStatus === 'checking'">
                                <span class="text-sky-400"><i class="fas fa-circle-notch animate-spin-slow mr-1"></i> Verificando disponibilidad...</span>
                            </template>
                            <template x-if="nameStatus === 'available'">
                                <span class="text-emerald-400"><i class="fas fa-check mr-1"></i> ¡Nombre disponible!</span>
                            </template>
                            <template x-if="nameStatus === 'taken'">
                                <span class="text-red-400"><i class="fas fa-xmark mr-1"></i> Ese nombre ya está en uso.</span>
                            </template>
                            <template x-if="nameStatus === 'short'">
                                <span class="text-amber-400"><i class="fas fa-triangle-exclamation mr-1"></i> Mínimo 3 caracteres.</span>
                            </template>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" required
                                   x-model="email" @input="emailTouched = true"
                                   placeholder="tu@correo.com"
                                   :class="emailBorderClass"
                                   class="w-full bg-slate-900/80 border border-slate-800/80 rounded-2xl px-4 py-3.5 pl-11 pr-11 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-sky-500/40 transition-all shadow-inner">
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 text-xs" x-show="emailTouched && email.length > 0" x-cloak>
                                <i :class="emailValid ? 'fas fa-circle-check text-emerald-400' : 'fas fa-circle-xmark text-red-400'"></i>
                            </span>
                        </div>
                        <div class="pl-1 text-[10px] font-bold" x-show="emailTouched && email.length > 0 && !emailValid" x-cloak>
                            <span class="text-red-400"><i class="fas fa-xmark mr-1"></i> Ingresa un correo válido (ejemplo@dominio.com).</span>
                        </div>
                        <div class="pl-1 text-[10px] font-bold" x-show="emailTouched && emailValid" x-cloak>
                            <span class="text-emerald-400"><i class="fas fa-check mr-1"></i> Correo con formato correcto.</span>
                        </div>
                    </div>

                    <!-- ── CONTRASEÑA ── -->
                    <div class="space-y-1.5">
                        <label for="password" class="text-[11px] font-black uppercase tracking-wider text-slate-400 block pl-1">Contraseña</label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none w-4 flex justify-center">
                        ...
                        <div x-show="password.length > 0" x-cloak class="space-y-2 pt-1">
                            <div class="flex items-center justify-between px-1">
                                <span class="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Seguridad</span>
                                <span class="text-[10px] font-black uppercase tracking-wider" :class="pwStrengthTextColor" x-text="pwStrengthLabel"></span>
                            </div>
                            <!-- Barra gradiente -->
                            ...
                            <div class="grid grid-cols-2 gap-x-4 gap-y-1 pt-1">
                                <div class="flex items-center gap-1.5 text-[10px]"
                                    ...
                                    <i :class="pwLen ? 'fas fa-circle-check' : 'far fa-circle'" class="text-[9px] w-3 shrink-0"></i>
                                    Mínimo 8 caracteres
                                </div>
                                <div class="flex items-center gap-1.5 text-[10px]"
                                     :class="pwUpper ? 'text-emerald-400' : 'text-slate-500'">
                                    <i :class="pwUpper ? 'fas fa-circle-check' : 'far fa-circle'" class="text-[9px] w-3 shrink-0"></i>
                                    Una mayúscula (A-Z)
                                </div>
                                <div class="flex items-center gap-1.5 text-[10px]"
                                     :class="pwNumber ? 'text-emerald-400' : 'text-slate-500'">
                                    <i :class="pwNumber ? 'fas fa-circle-check' : 'far fa-circle'" class="text-[9px] w-3 shrink-0"></i>
                                    Un número (0-9)
                                </div>
                                <div class="flex items-center gap-1.5 text-[10px]"
                                     :class="pwSpecial ? 'text-emerald-400' : 'text-slate-500'">
                                    <i :class="pwSpecial ? 'fas fa-circle-check' : 'far fa-circle'" class="text-[9px] w-3 shrink-0"></i>
                                    Un símbolo (!@#$...)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-1.5">
                        <label for="password_confirmation" class="text-[11px] font-black uppercase tracking-wider text-slate-400 block pl-1">Confirmar Contraseña</label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none w-4 flex justify-center">
                                <i class="fas fa-shield-halved text-xs"></i>
                            </span>
                            <input :type="showConfirm ? 'text' : 'password'" id="password_confirmation" name="password_confirmation" required
                                   x-model="confirm" @input="confirmTouched = true"
                        ...
                        <div class="pl-1 text-[10px] font-bold" x-show="confirmTouched && confirm.length > 0" x-cloak>
                            <span x-show="confirmMatch" class="text-emerald-400"><i class="fas fa-check mr-1"></i> Las contraseñas coinciden.</span>
                            <span x-show="!confirmMatch" class="text-red-400"><i class="fas fa-xmark mr-1"></i> Las contraseñas no coinciden.</span>
                        </div>
                    </div>

                    <!-- ── COLORES DE MARCA ── -->
                    <div class="border-t border-white/5 pt-5">
                        <label class="text-[11px] font-black uppercase tracking-wider text-slate-400 block pl-1 mb-3">
                            <i class="fas fa-palette mr-1.5 text-sky-400"></i> Colores de tu Marca
                        </label>

                        <p class="text-[9px] text-slate-500 uppercase tracking-widest font-bold mb-2 pl-1">Paletas rápidas:</p>
                        <div class="flex items-center gap-2 flex-wrap mb-4">
                            <template x-for="(preset, idx) in presets" :key="idx">
                                <button type="button" @click="applyPreset(idx)"
                                        :title="preset.name"
                                        class="flex items-center gap-0.5 p-1 rounded-xl border transition-all duration-200"
                                        :class="selectedPreset === idx ? 'border-sky-400/60 bg-white/5 shadow-[0_0_8px_rgba(56,189,248,0.2)]' : 'border-white/5 hover:border-white/20'">
                                    <span class="w-5 h-5 rounded-full shadow-inner" :style="`background:${preset.primary}`"></span>
                                    <span class="w-5 h-5 rounded-full shadow-inner" :style="`background:${preset.accent}`"></span>
                                    <span class="w-5 h-5 rounded-full border border-white/10" :style="`background:${preset.bg}`"></span>
                                </button>
                            </template>
                        </div>

                        <div class="grid grid-cols-3 gap-3">
                            <div class="bg-slate-900/60 border border-white/5 rounded-2xl p-3 flex flex-col items-center gap-2">
                                <span class="text-[9px] font-black text-slate-500 uppercase tracking-widest">Primario</span>
                                <div class="relative w-10 h-10 rounded-full overflow-hidden border-2 border-white/20 shadow-lg cursor-pointer hover:border-white/40 transition-colors">
                                    <div class="absolute inset-0" :style="`background:${primaryColor}`"></div>
                                    <input type="color" x-model="primaryColor" name="color_primary" class="absolute inset-0 opacity-0 cursor-pointer w-full h-full">
                            ...
                            <div class="bg-slate-900/60 border border-white/5 rounded-2xl p-3 flex flex-col items-center gap-2">
                                <span class="text-[9px] font-black text-slate-500 uppercase tracking-widest">Acento</span>
                                <div class="relative w-10 h-10 rounded-full overflow-hidden border-2 border-white/20 shadow-lg cursor-pointer hover:border-white/40 transition-colors">
                                    <div class="absolute inset-0" :style="`background:${accentColor}`"></div>
                                    <input type="color" x-model="accentColor" name="color_accent" class="absolute inset-0 opacity-0 cursor-pointer w-full h-full">
                                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                                        <i class="fas fa-eye-dropper text-white/70 text-[8px] drop-shadow"></i>
                                    </div>
                                </div>
                            ...
                            <div class="bg-slate-900/60 border border-white/5 rounded-2xl p-3 flex flex-col items-center gap-2">
                                <span class="text-[9px] font-black text-slate-500 uppercase tracking-widest">Fondo</span>
                                <div class="relative w-10 h-10 rounded-full overflow-hidden border-2 border-white/20 shadow-lg cursor-pointer hover:border-white/40 transition-colors">
                                    <div class="absolute inset-0" :style="`background:${bgColor}`"></div>
                                    <input type="color" x-model="bgColor" name="color_bg" class="absolute inset-0 opacity-0 cursor-pointer w-full h-full">
                                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                                        <i class="fas fa-eye-dropper text-white/70 text-[8px] drop-shadow"></i>
                                    </div>
                                </div>
                        ...
                        <!-- Preview de marca -->
                        <div class="mt-3 rounded-2xl overflow-hidden border border-white/5 shadow-inner transition-all duration-300" :style="`background:${bgColor}`">
                            <div class="px-4 py-3 flex items-center gap-3">
                                <div class="w-9 h-9 rounded-full flex items-center justify-center text-white text-[11px] font-black shrink-0 shadow-md" :style="`background:${primaryColor}`">WI</div>
                                <div class="flex-1 min-w-0">
                                    <div class="h-2 rounded-full w-3/4 mb-1.5 opacity-80" :style="`background:${primaryColor}`"></div>
                                    <div class="h-1.5 rounded-full w-1/2 opacity-50" :style="`background:${accentColor}`"></div>
                                </div>
                                <div class="px-3 py-1.5 rounded-xl text-[9px] font-black text-white shrink-0 shadow-md" :style="`background:${accentColor}`">Ver Menú</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-2">
                        <button type="submit"
                            ...
                            <span x-text="formValid ? 'Iniciar Prueba Gratis — 7 Días' : 'Completa el formulario correctamente'"></span>
                        </button>
                    ...
                    <p class="text-center text-[10px] text-slate-500 leading-relaxed">
                        ¿Ya tienes cuenta?
                        <a href="/login" class="text-cyan-400 font-bold hover:text-cyan-300 transition-colors">Inicia Sesión aquí</a>
                    </p>
                </form>
            </div>
    ...
    <div x-show="showTrialModal" class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4" x-cloak>
        ...
        <div x-show="showTrialModal"
            ...
            <div class="px-8 pt-7 pb-0 text-center">
                <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500/20 to-cyan-500/10 border border-sky-500/30 flex items-center justify-center mx-auto mb-3 shadow-[0_0_20px_rgba(14,165,233,0.2)]">
                ...
                <p class="text-xs text-slate-400 mt-1.5 leading-relaxed max-w-xs mx-auto">
                    <span class="text-sky-400 font-black">7 días</span> sin pagos, sin comisiones. <span class="text-white font-bold">Totalmente gratis</span> para que pruebes.
                </p>
            </div>

            <div class="mx-8 mt-6 bg-gradient-to-r from-sky-500/10 to-cyan-500/10 border border-sky-500/20 rounded-2xl p-4 flex items-center justify-between gap-3">
                <div class="flex items-center gap-3">
                    <div class="flex flex-col items-center justify-center w-14 h-14 rounded-xl bg-sky-500/15 border border-sky-500/25 shrink-0">
            ...
            <div class="mx-8 mt-4 bg-amber-500/[0.07] border border-amber-500/25 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div>
                    <p class="text-[11px] font-black text-amber-300 uppercase tracking-wide mb-1">Aviso de Suscripción</p>
            ...
            <div class="mx-6 mt-4">
                <p class="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2 pl-1">Incluye durante los 7 días:</p>
