...
<div class="rounded-2xl border border-white/10 bg-[#0d1127]/80 backdrop-blur-md shadow-xl overflow-hidden">
    ...
    <p class="px-4 py-3 text-[11px] text-slate-400 border-t border-white/5 text-center">
        <span class="inline-flex items-center justify-center gap-1.5 flex-wrap">
            ...
            Precios en USD · equivalente en Bs. según <strong class="text-amber-200/90">tasa BCV</strong>
        </span>
    </p>
</div>
