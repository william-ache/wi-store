    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
            ...
            <article class="landing-why-card">
                <div class="landing-why-card__visual flex items-center justify-center p-6 md:p-8" aria-hidden="true">
                    <div class="relative w-full max-w-[260px] aspect-[4/3]">
            ...
            {{-- 2. Tiempo --}}
            <article class="landing-why-card">
                <div class="landing-why-card__visual p-5 md:p-6" aria-hidden="true">
                    <div class="w-full max-w-[280px] mx-auto rounded-xl bg-white border border-slate-200/90 shadow-sm p-4">
