        ...
        <div x-show="showModal" 
            ...
            <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between sticky top-0 z-10 bg-white dark:bg-slate-900 transition-colors duration-300">
                <div>
                    ...
                    <h3 class="text-base md:text-lg font-black text-slate-800 dark:text-slate-100 mt-0.5" x-text="isEdit ? 'Modificar Cliente' : 'Registrar Cliente'">Registrar Cliente</h3>
                </div>
            ...
            <!-- Formulario -->
            <form id="clientForm" @submit.prevent="submitForm($data)" class="p-6 space-y-4">
                <!-- Nombre -->
                <div>
                    <label for="name" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Nombre Completo</label>
                ...
                <!-- Teléfono -->
                <div>
                    <label for="phone" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Teléfono de Contacto</label>
                ...
                <!-- Correo Electrónico -->
                <div>
                    <label for="email" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Correo Electrónico (Opcional)</label>
                ...
                <div>
                    ...
                    <select id="status" x-model="clientStatus" class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition">
