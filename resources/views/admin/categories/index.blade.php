        ...
        <div x-show="showModal" 
            ...
            <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between sticky top-0 z-10 bg-white dark:bg-slate-900 transition-colors duration-300">
                <div>
                    ...
                    <h3 class="text-base md:text-lg font-black text-slate-800 dark:text-slate-100 mt-0.5" x-text="isEdit ? 'Modificar Categoría' : 'Registrar Categoría'">Registrar Categoría</h3>
                </div>
            ...
            <!-- Formulario -->
            <form id="categoryForm" @submit.prevent="submitForm($data)" class="p-6 space-y-4">
                <!-- Nombre -->
                <div>
                    <label for="name" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Nombre de la Categoría</label>
                ...
                <!-- Estado -->
                <div>
                    <label for="status" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Estado</label>
                    <select id="status" x-model="categoryStatus" class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                    <button type="button" @click="closeModal()" class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-700 dark:text-slate-300 font-bold text-xs px-5 py-3 rounded-xl transition shadow-sm active:scale-95">
                        Cancelar
                    </button>
